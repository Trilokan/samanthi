...
class Appointment(models.TransientModel):
    ...
    employee_id = fields.Many2one(comodel_name="lam.person", string="Doctor/ Employee")
    patient_id = fields.Many2one(comodel_name="lam.person", string="Person")
...
class AppointmentDetail(models.TransientModel):
    ...
    employee_id = fields.Many2one(comodel_name="lam.person", string="Doctor")
    patient_id = fields.Many2one(comodel_name="lam.person", string="Person")
