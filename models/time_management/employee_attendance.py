...
class EmployeeAttendance(models.Model):
    ...
    person_id = fields.Many2one(comodel_name="qin.person", string="Employee", readonly=True)
    ...
    _sql_constraints = [('unique_employee_attendance', 'unique (attendance_id, person_id)',
