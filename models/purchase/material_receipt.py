...
class MaterialReceipt(models.Model):
    ...
    person_id = fields.Many2one(comodel_name="lam.person", string="Person", readonly=True)
    ...
    received_by = fields.Many2one(comodel_name="lam.person", string="Received By", readonly=True)
    inspected_by = fields.Many2one(comodel_name="lam.person", string="Inspected By", readonly=True)
